...
@section('content')
    ...
    <div class="modal fade" id="cat_modify_modal" tabindex="-1" role="dialog" aria-labelledby="cat_modify_modal_label_1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <input name="object_id" value="" id="cat_uid_input">
                        {{ csrf_field() }}
    ...
    <div class="modal fade" id="cat_add_modal" tabindex="-1" role="dialog" aria-labelledby="cat_modify_modal_label_1">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                    <button type="button" id ="add_tag_form_submit" class="btn btn-primary">确认</button>
                </div>
            </div>
        </div>
    </div>
