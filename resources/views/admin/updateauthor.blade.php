...
@section('content')
                        ...
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form id="add_author_form">
                                    <input style="display: none;" value="{{$author->object_id}}" name="object_id">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="button-list mt-25">
                                            <img id="avatar_preview" style="width: 100px;" src="{{$author->avatar}}"/>
                                            <br/>
                                            <div
                                                    data-toggle="modal"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="5" name="introduction"
                                                  id="author_intro">{{$author->introduction}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label mb-10 text-left">关注领域</label>
                                        <input style="display: none;" type="text" class="form-control" name="interest" id="author_interest" value="{{$author->interest}}">
                                    ...
                                    <div class="form-group mb-0">
                                        <button type="button" id="author_form_submit" class="btn btn-success pull-right"><span class="btn-text">修改</span></button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <input id="page_name" style="display: none;" value="updateAuthor">
@endsection
